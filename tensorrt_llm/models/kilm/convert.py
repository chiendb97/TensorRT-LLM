...
def convert_hf_kilm(hf_model,
    ...
    assert mha_mode == True, "KiLM uses MHA."
...
def from_hugging_face(cls,
    ...
    assert kilm_type in [
        'kilm', 'kilm2'
    ], "Unsupported KiLM type. Must be either 'kilm' or 'kilm2'"
...
def quantize(dtype,
    ...
    act_range, kilm_qkv_para, kilm_smoother = smooth_quant(
        model, kilm_type, model_dir, dataset_cache_dir, smoothquant_val)
