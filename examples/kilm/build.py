...
from weight import (load_from_awq_kilm, load_from_binary, load_from_gptq_kilm,
                    load_from_hf_kilm)
...
def get_model_object(args, mapping, trt_dtype=None):
    ...
    if args.per_group:
        ...
        logger.info(f'Loading HF KiLM ... from {args.model_dir}')
        tik = time.time()
        ...
        logger.info(f'Loading KiLM ... from {args.bin_model_dir}')
        load_from_binary(tensorrt_llm_kilm,
                         args.bin_model_dir,
                         mapping,
                         dtype=args.dtype,
                         multi_query_mode=(args.n_kv_head != args.n_head))
...
def build_rank_engine(builder: Builder,
    ...
    # Initialize Module
    tensorrt_llm_kilm = get_model_object(args, mapping=mapping, trt_dtype=dtype)
