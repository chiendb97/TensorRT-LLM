...
from tensorrt_llm.models.kilm.convert import from_hugging_face, quantize
...
def convert_and_save_hf(args):
    ...
    if args.smoothquant is not None or args.int8_kv_cache:
        ...
        mapping = Mapping(
            ...
            tp_size=args.tp_size,
            pp_size=args.pp_size)
        #TODO: change to KiLMForCausalLM.quantize later
        quantize(args.dtype,
                 args.model_dir,
                 args.output_dir,
                 mapping=mapping,
        ...
        def convert_and_save_rank(args, rank):
            mapping = Mapping(world_size=world_size,
                              ...
                              tp_size=args.tp_size,
                              pp_size=args.pp_size)
            #TODO: change to KiLMForCausalLM.from_hugging_face later
            kilm = from_hugging_face(
                KiLMForCausalLM,
                hf_model,
                model_dir,
                args.dtype,
                ...
                override_fields=override_fields)
            kilm.save_checkpoint(args.output_dir, save_config=(rank == 0))
            del kilm
            release_gc()
